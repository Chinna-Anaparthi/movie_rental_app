...
import './Movie.css';
import { Button, Card, CardActions, CardContent, CardMedia, Container, TextField, Select, MenuItem } from '@mui/material';
  ...
  return (
    <Container className="center">
      <div className="search-container">
        ...
        &nbsp;
        <Button variant="contained" onClick={getMovies}>Search</Button>
      </div>
